...
# numérico limite e imprima los números pares hasta ese límite.y
...
# numérico n e imprima una matriz cuadrada de tamaño n x n donde los elementos
# son el resultado de la suma de sus índices de fila y columna.
